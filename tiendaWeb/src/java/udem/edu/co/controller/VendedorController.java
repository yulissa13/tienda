...
import udem.edu.co.facade.VendedorFacade;
...
public class VendedorController implements Serializable {
    ...
    @EJB
    private udem.edu.co.facade.VendedorFacade ejbFacade;
    ...
    public String createVendedor(){
        ...
        selected = getFacade().loginVendedor(selected);
        if (selected!=null) {
            
            return "index.xhtml";
        }else{            
            FacesMessage message = new FacesMessage(FacesMessage.SEVERITY_INFO, "Login Mensaje", "Usuario o password incorrecto.");
